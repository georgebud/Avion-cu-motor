...
void main() {
	...
	float disp = snoise3d(v_position);
	//vec3 position = v_position + (v_normal * disp * 2.0 * sin(time * 2.0));
	
	vec3 position = v_position + disp * 0.8 * sin(0.2);
